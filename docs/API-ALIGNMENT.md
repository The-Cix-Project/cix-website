...
The reproduced workflow remains captured from Cix commit `4d5f4ffa167520f0e4a64825b4c6c9a5a28942c7` (2026-09-01 20:07:21 +01:00). The current product contract reviewed for this website update is Cix commit `5c3b277d` (2026-09-11), including the unified package/image/deployment/host pipeline, image-readiness waits for deployments, explicit approval gates, rolling-rootfs freshness, and the previously reviewed volume, resource-view, wireless, device, and kernel-module work.
