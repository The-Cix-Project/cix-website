...
- Refreshed the product alignment against Cix `65b21996` / live `v2.57.238`: documented the separate flat `cix-recipes` corpus, refreshed PBS/CPDL and CBS execution claims, recorded credential-regression protection and safe hard-link extraction, corrected the build-system boundary, refreshed status provenance, and updated the homepage host identity.
