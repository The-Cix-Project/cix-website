...
- Refreshed the product alignment against Cix `b7ece3b7` / live `v2.57.238`: documented the separate flat `cix-recipes` corpus, refreshed PBS/CPDL and CBS execution claims, corrected the build-system boundary, refreshed status provenance, and updated the homepage host identity.
